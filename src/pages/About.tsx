      ...
      <section className="max-w-3xl mx-auto px-6 pt-16 sm:pt-20 pb-14 sm:pb-20">
        ...
        <FadeIn delay={100}>
          <div id="intro" className="mb-28 scroll-mt-28">
            <h2 className="text-2xl sm:text-4xl font-bold text-accent-500 mb-1">
              소개
            </h2>
            <div className="w-8 h-[2px] bg-accent-500 rounded-full mb-8" />
            <div className="space-y-5">
              <h3 className="text-xl sm:text-3xl font-medium text-mono-100 leading-[1.7]">
                사용자의
              ...
              <p className="text-base text-mono-400 leading-[1.9]">
            ...
            <div className="space-y-0">
              {experiences.map((exp, i) => (
                ...
                >
                  ...
                  <p className="text-base text-mono-400 leading-[1.8]">
                    {exp.description}
                  </p>
                </div>
              ))}
          ...
          <div id="skills" className="mb-28 scroll-mt-28">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {skillCategories.map((cat) => (
                  ...
                  >
                    <h3 className="text-base font-semibold text-mono-100 mb-4">{cat.category}</h3>
          ...
          <div id="education" className="scroll-mt-28">
            ...
            <div className="space-y-3">
              {education.map((edu, i) => (
                ...
                >
                  <p className="text-base text-mono-200">{edu.title}</p>
